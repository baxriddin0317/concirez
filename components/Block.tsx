  ...
  return (
    <section className='relative mt-14'>
      <div className='max-w-7xl relative mx-auto px-4 lg:px-5'>
        <div className='absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 -z-10 w-96 h-48 md:w-[942px] md:h-[425px] bg-brand-orange blur-[136px]'></div>
        <div className="absolute -z-10 top-0 left-1/2 -translate-x-1/2 w-[556px] h-[109px] rounded-[756.046px] blur-[109px] bg-brand-orange"></div>
